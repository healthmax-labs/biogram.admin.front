...
export default {
    ...
    Status: {
        RiskFctr: {
            ...
            MergeCells: ['A1:F1', 'G1:L1', 'M1:O1', 'P1:Q1', 'R1:U1'],
            Data: [],
            SpliceColumn: false,
            SpliceColumns: [{ start: 1, end: 1 }],
            SpliceMergeCells: ['A1:E1', 'F1:K1', 'L1:N1', 'O1:P1', 'Q1:T1'],
        },
        StressList: {
        ...
        BrainList: {
            ...
            MergeCells: ['A1:C1', 'D1:G1', 'H1:I1', 'J1'],
            Data: [],
            SpliceColumn: false,
            SpliceColumns: [{ start: 1, end: 1 }],
            SpliceMergeCells: ['A1:B1', 'C1:F1', 'G1:H1', 'I1'],
        },
        BrftrCmpr: {
