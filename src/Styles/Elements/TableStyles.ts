...
export const ModalDefaultTableStyle = {
    ...
    TableBody: tw.tbody`w-full h-[50vh] bg-gray-100 flex flex-col text-center items-center overflow-y-scroll`,
    ...
    TableBodyEmptyCell: tw.td`flex w-full text-center justify-center w-2/4 py-2 h-8 text-xs text-gray-500 border-gray-100`,
