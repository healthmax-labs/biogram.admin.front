...
export const CommonListTableStyle = {
    ...
    TableBodyCell: tw.td`flex items-center w-full justify-center h-9 align-middle text-xs uppercase border-l-0 border-r-0 whitespace-nowrap text-center text-gray-500 border-gray-100`,
}
