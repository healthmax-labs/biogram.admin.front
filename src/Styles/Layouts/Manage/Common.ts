...
export const ManageLayoutCenterWapper = tw.div`pl-2 pr-2 mx-auto w-full -mt-44`
...
export const SidebarCollapseHeader = tw.div`bg-white mb-4 block border-b border-solid pb-4 md:hidden md:min-w-full`
...
export const TopbarContainer = tw.nav`top-0 left-0 w-full z-10 bg-transparent flex-row flex-nowrap justify-start flex items-center p-1`
