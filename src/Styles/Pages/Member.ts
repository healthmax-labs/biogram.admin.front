...
export const SearchBoxLabelItem = tw.div`w-1/6`
...
export const SearchBoxSelect = tw.select`form-input block w-60 border border-gray-300 bg-white rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 text-xs`
export const SearchBoxInput = tw.input`form-input block w-60 border border-gray-300 bg-white rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 text-xs`
...
export const SearchBoxSearchButtonBox = tw.div`absolute bottom-0 -right-3`
...
export const TableThead = tw.thead`w-full flex text-white text-xs`
export const TableTr = tw.tr`w-full flex bg-m-dip-blue`
export const TableTh = tw.th`p-4 w-1/4 px-4 align-middle border border-solid py-1 text-xs uppercase border-l-0 border-r-0 whitespace-nowrap text-center text-white border-gray-100`
...
export const TableTbodyTr = styled.tr(({ BgState }: { BgState: boolean }) => [
    BgState ? tw`flex w-full bg-white` : tw`flex w-full`,
])

export const TableTbodyTd = tw.td`p-4 w-1/4 align-middle border border-solid py-1 text-xs uppercase border-l-0 border-r-0 whitespace-nowrap text-center text-gray-500 border-gray-100`
