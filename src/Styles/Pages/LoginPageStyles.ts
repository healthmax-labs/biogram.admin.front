...
export const LoginPageStyle = {
    ...
    LoginButton: tw.div`w-full text-center transform rounded-md bg-blue-700 px-4 py-2 tracking-wide text-white transition-colors duration-200 hover:bg-blue-600 focus:bg-blue-600 focus:outline-none`,
