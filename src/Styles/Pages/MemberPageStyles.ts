...
export const Members = {
    ...
    Table: {
        ...
        Tr: tw.tr`w-full flex bg-m-dip-blue items-center`,
        ...
        Th: tw.th`p-4 w-1/4 px-3 align-middle py-1 text-xs uppercase border-l-0 border-r-0 whitespace-nowrap text-center text-white border-gray-100`,
