...
export const ContentsStyle = {
    ...
    Table: {
        ...
        TheadCellWfix: tw.th`border bg-steel text-xs text-white -mx-4`,
        TheadCellHeadText: tw.div`flex justify-center min-w-min -mx-4`,
        TheadCellItem: tw.div`flex w-full justify-center`,
        Body: tw.tbody``,
        Row: tw.tr`w-full`,
        BlankRow: tw.tr`h-5`,
        Cell: tw.td`border text-xs text-gray-500 object-center min-w-fit`,
